...
![Alt Text](https://github.com/Kurssiesitieto/kurssiesitieto-ohtuprojekti/blob/main/documentation/images/mainpage.png)
...
[Link to the visualization tool](https://study.cs.helsinki.fi/esitieto/) 
